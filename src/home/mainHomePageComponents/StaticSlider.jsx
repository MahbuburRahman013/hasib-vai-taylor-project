...
function StaticSlider() {
    ...
    return (
        <div className='lg:mt-28  text-white xl:gap-24 gap-10 md:px-24 sm:px-12 px-10 py-10 mx-auto relative flex flex-col-reverse lg:flex-row  items-start justify-between bg-gradient-to-r from-[#FFBE00] to-[#FFCF3F]'>
            <div className={`lg:w-[50%] xl:pl-5`}>
                <h1 className="xl:text-6xl sm:text-5xl text-3xl">Getting savvy about media literacy</h1>
